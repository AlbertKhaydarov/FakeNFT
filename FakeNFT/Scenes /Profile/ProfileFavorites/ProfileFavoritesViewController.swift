...
class ProfileFavoritesViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(ProfileFavoritesCollectionViewCell.self, forCellWithReuseIdentifier: ProfileFavoritesCollectionViewCell.profileFavoritesCellIdentifier)
...
extension ProfileFavoritesViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ProfileFavoritesCollectionViewCell.profileFavoritesCellIdentifier, for: indexPath) as? ProfileFavoritesCollectionViewCell else {return UICollectionViewCell()}
