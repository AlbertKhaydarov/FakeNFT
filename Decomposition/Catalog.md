...
- Написаны основные UI тесты на все функциональности - (est: 1.5h., fact: 2h.)
- Темная тема - (est: 1h., fact: 5m.)
- Локализация - (est: 30m., fact: 5m.)
- Реализован LaunchScreen - (est: 5m., fact: 5m.)

Итого: (est: 6.5h., fact: ~5h.+)

# По предварительным оценкам, общая работа: (est: ~16h., fact: ~15h+.)
